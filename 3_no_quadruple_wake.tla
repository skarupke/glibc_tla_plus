...
\* BEGIN TRANSLATION (chksum(pcal) = "4d21cc13" /\ chksum(tla) = "7db4f936")
...
\* Label check_for_waiters of procedure cv_signal at line 382 col 3 changed to check_for_waiters_
...
\* Procedure variable local_wseq of procedure cv_signal at line 377 col 11 changed to local_wseq_c
\* Procedure variable g1 of procedure cv_signal at line 378 col 11 changed to g1_
\* Procedure variable do_futex_wake of procedure cv_signal at line 379 col 11 changed to do_futex_wake_
\* Procedure variable local_wseq of procedure cv_broadcast at line 431 col 11 changed to local_wseq_cv
\* Procedure variable g1 of procedure cv_broadcast at line 432 col 11 changed to g1_c
...
cv_wait(self) == cv_wait_fetch_seq(self) \/ cv_wait_incr_wrefs(self)
                    ...
                    \/ cv_wait_inner_loop_done(self) \/ cv_wait_done(self)
...
\* Last modified Sun Jan 22 20:51:17 EST 2023 by malte
