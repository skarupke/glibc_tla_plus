...
\* BEGIN TRANSLATION (chksum(pcal) = "c5d7e3e3" /\ chksum(tla) = "cee5ebc1")
...
\* Label check_for_waiters of procedure cv_signal at line 357 col 3 changed to check_for_waiters_
...
\* Procedure variable local_wseq of procedure cv_signal at line 352 col 11 changed to local_wseq_c
\* Procedure variable g1 of procedure cv_signal at line 353 col 11 changed to g1_
\* Procedure variable do_futex_wake of procedure cv_signal at line 354 col 11 changed to do_futex_wake_
\* Procedure variable local_wseq of procedure cv_broadcast at line 406 col 11 changed to local_wseq_cv
\* Procedure variable g1 of procedure cv_broadcast at line 407 col 11 changed to g1_c
...
cv_wait_reload_g1_start(self) == /\ pc[self] = "cv_wait_reload_g1_start"
                                 ...
                                 /\ lowseq' = [lowseq EXCEPT ![self] = IF (local_g1_start'[self] % 2) = g[self] THEN signals[self] ELSE ClearBit(local_g1_start'[self], 0)]
...
cv_wait_cmp_exchg(self) == /\ pc[self] = "cv_wait_cmp_exchg"
                           /\ IF futexes[g_signals_index[g[self]]].state = signals[self]
                                 THEN /\ futexes' = [futexes EXCEPT ![g_signals_index[g[self]]].state = signals[self] - 2]
...
yield_loop(self) == /\ pc[self] = "yield_loop"
                    ...
                    /\ UNCHANGED << mutex_index, g1_orig_size_index, 
                                    ...
                                    old_state_u, orig_size, old_state, 
                                    local_wseq, g1, old_orig_size, 
                                    old_g1_start, r, s, lowseq_, local_wseq_c, 
                                    g1_, do_futex_wake_, local_wseq_cv, g1_c, 
                                    do_futex_wake, num_loops >>
...
proc_start(self) == /\ pc[self] = "proc_start"
                    ...
                    /\ UNCHANGED << mutex_index, g1_orig_size_index, 
                                    ...
                                    local_wseq, g1, old_orig_size, 
                                    old_g1_start, r, s, lowseq_, local_wseq_, 
                                    g, seq, signals, local_g1_start, lowseq, 
                                    local_wseq_c, g1_, do_futex_wake_, 
                                    local_wseq_cv, g1_c, do_futex_wake >>
...
proc_done(self) == /\ pc[self] = "proc_done"
                   ...
                   /\ UNCHANGED << mutex_index, g1_orig_size_index, 
                                   ...
                                   r, s, lowseq_, local_wseq_, g, seq, signals, 
                                   local_g1_start, lowseq, local_wseq_c, g1_, 
                                   do_futex_wake_, local_wseq_cv, g1_c, 
                                   do_futex_wake, num_loops >>
...
\* Last modified Sun Jan 22 20:51:48 EST 2023 by malte
